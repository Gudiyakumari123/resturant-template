                            ...
                            <form className="space-y-5" onSubmit={submitForm}>
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="Email" type="email" placeholder="Enter Password" className="form-input pl-10 placeholder:text-white-dark" />
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        <input id="Email" type="email" placeholder="Enter confirm Password" className="form-input pl-10 placeholder:text-white-dark" />
                                        <span className="absolute left-4 top-1/2 -translate-y-1/2">
                                            <IconMail fill={true} />
                                        </span>
                                    </div>
